...
void cairo_dock_render_linear (CairoDock *pDock)
{
	...
	cairo_dock_draw_frame (pCairoContext, fRadius, fLineWidth, fDockWidth, pDock->iMaxIconHeight + 2 * fMargin, fDockOffsetX, fDockOffsetY, sens, 0, pDock->bHorizontalDock);
