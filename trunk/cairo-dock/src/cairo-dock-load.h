...
#define cairo_dock_fill_icon_buffers_for_desklet(pIcon, pSourceContext, bLoadReflect) cairo_dock_fill_icon_buffers (pIcon, pSourceContext, 1, CAIRO_DOCK_HORIZONTAL, bLoadReflect);
